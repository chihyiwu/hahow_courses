...
if __name__ == '__main__':
    ...
    print('平均募資價:', round(np.mean(pre_order_prices),2))
    print('平均上線價:', round(np.mean(prices),2))
    print('平均學生數:', round(np.mean(tickets),2))
    print('平均課程分鐘:', round(np.mean(lengths)/60,2))